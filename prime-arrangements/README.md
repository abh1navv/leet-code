<h2>1175. Prime Arrangements</h2><h3>Easy</h3><hr><div><p>Return the number of permutations of 1 to <code>n</code> so that prime numbers are at prime indices (1-indexed.)</p>
